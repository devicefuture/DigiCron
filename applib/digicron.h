...
WASM_IMPORT("digicron", "dc_timing_EarthTime_daysInMonth") unsigned int dc_timing_EarthTime_daysInMonth(_dc_Sid sid);
...
WASM_IMPORT("digicron", "dc_ui_Screen_printString") void dc_ui_Screen_printString(_dc_Sid sid, _dc_String string);
...
namespace timing {
    class EarthTime {
        ...
        public:
            ...
            unsigned int daysInMonth() {return dc_timing_EarthTime_daysInMonth(this->_sid);}
...
namespace ui {
    ...
    class Icon {
        ...
        public:
            ...
            void setPixel(unsigned int x, unsigned int y, PenMode value) {return dc_ui_Icon_setPixel(this->_sid, x, y, value);}
    };
    ...
    class Screen {
        ...
        public:
            ...
            void setPixel(unsigned int x, unsigned int y, PenMode value) {return dc_ui_Screen_setPixel(this->_sid, x, y, value);}
            ...
            void print(_dc_String string) {return dc_ui_Screen_printString(this->_sid, string);}
            void print(Icon icon) {return dc_ui_Screen_printIcon(this->_sid, _dc_getClassSid<Icon>(&icon));}
            ...
            void rect(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2, PenMode value) {return dc_ui_Screen_rect(this->_sid, x1, y1, x2, y2, value);}
            void filledRect(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2, PenMode value) {return dc_ui_Screen_filledRect(this->_sid, x1, y1, x2, y2, value);}
            void open(bool urgent) {return dc_ui_Screen_open(this->_sid, urgent);}
            void close() {return dc_ui_Screen_close(this->_sid);}
            void swapWith(Screen* currentScreen) {return dc_ui_Screen_swapWith(this->_sid, _dc_getClassSid<Screen>(currentScreen));}
    };
}
