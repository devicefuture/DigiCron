...
namespace ui
    ...
    class Icon
        ...
        method "void" setPixel "unsigned int" x "unsigned int" y "ENUM PenMode" value
    ...
    class Screen
        ...
        INTERNAL_NAME=dc_ui_Screen_printString method "void" print "STRING" string
        INTERNAL_NAME=dc_ui_Screen_printIcon method "void" print "CLASS Icon" icon
        ...
        method "void" rect "unsigned int" x1 "unsigned int" y1 "unsigned int" x2 "unsigned int" y2 "ENUM PenMode" value
        method "void" filledRect "unsigned int" x1 "unsigned int" y1 "unsigned int" x2 "unsigned int" y2 "ENUM PenMode" value

        method "void" open "bool" urgent
        method "void" close
        method "void" swapWith "CLASSPTR Screen" currentScreen